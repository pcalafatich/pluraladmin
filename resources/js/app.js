/*
Template Name: Plural - Admin & Dashboard Template
Author: RaitNauDigital
Version: 1.0.0
Website: https://raitnaudigital.com/
Contact: info@raitnaudigital.com
File: Main Js File
*/
  ...
  function setLanguage(lang) {
    document.getElementsByClassName("header-lang-img").forEach(function (el) {
      if (el) {
        switch (lang) {
          case "sp":
            el.src = "assets/images/flags/argentina.jpg";
            break;
          default:
            el.src = "assets/images/flags/argentina.jpg";
            break;
