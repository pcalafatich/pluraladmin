...
@section('title') @lang('translation.Comerciosadheridos') @endsection
...
@slot('li_1') Listado @endslot
@slot('title') Comercios @endslot
@endcomponent
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="myExtraLargeModalLabel">Agregar Comercio</h5>
            ...
            <div class="modal-body">
                ...
                <div class="col-12 text-end">
                    <button type="button" class="btn btn-danger me-1" data-bs-dismiss="modal"><i class="bx bx-x me-1"></i> Cancelar</button>
                    <button type="submit" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#success-btn" id="btn-save-event"><i class="bx bx-check me-1"></i> Confirmar</button>
                </div>
            </div>
